        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="{{ url('admin/departement/create') }}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nom departement</label>
                                <input type="text" name="nom_departement" class="form-control" id="exampleInputEmail1" placeholder="Nom departement">
                            </div>
                        </div>
                        <!-- /.card-body -->
