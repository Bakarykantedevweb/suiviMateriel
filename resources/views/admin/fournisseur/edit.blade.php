        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="{{ url('admin/fournisseur/'.$fournisseur->id.'/edit') }}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nom Agence</label>
                                <input type="text" name="nom_fournisseur" value="{{ $fournisseur->nom }}" class="form-control" id="exampleInputEmail1" placeholder="Nom Fournisseur">
                            </div>
                        </div>
                        <!-- /.card-body -->
